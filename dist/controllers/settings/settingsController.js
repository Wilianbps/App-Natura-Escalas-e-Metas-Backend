...
function getAllEmployees(_req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const employees = yield (0, settingsModels_1.findAllEmployees)();
...
function updateStatusAndScaleFlowSettings(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!data)
                return res.status(400).end();
            const settings = yield (0, settingsModels_1.updateSettings)(data);
            if (settings.success) {
...
function updateShiftRestSchedule(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const update = yield (0, settingsModels_1.updateEmployee)(data);
            if (update.success) {
