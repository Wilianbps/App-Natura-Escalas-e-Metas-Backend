...
function findGoalsByFortnight(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!storeCode || !month || !year || !goalType)
                return res.status(400).send();
            const goals = yield (0, goalsModels_1.selectGoalsByDateOrderById)(storeCode.toString(), month.toString(), year.toString(), goalType.toString());
...
function findGoalsByWeek(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!storeCode || !month || !year || !goalType)
                return res.status(400).send();
            const goals = yield (0, goalsModels_1.selectGoalsByDate)(storeCode.toString(), month.toString(), year.toString(), goalType.toString());
