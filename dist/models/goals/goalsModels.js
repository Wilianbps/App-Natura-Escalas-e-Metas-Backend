...
function selectRankingGoalsLastTwelveMonths(storeCode, initialDate, lastDate) {
    return __awaiter(this, void 0, void 0, function* () {
        const months = [
            "Jan",
            "Fev",
        ...
        const pool = yield connection_1.default.openConnection(); // Abre a conexão
        try {
            const results = [];
            // Converter lastDate para um objeto Date
            const endDate = new Date(parseInt(lastDate.slice(0, 4)), // Ano
